...
{
    [Header("Nota")]
    public string noteName = "C4"; // nota real de la tecla (ej: "B3", "Cs4", "E5")
    ...
    // Mapeo nota real → sample más cercano del Salamander
    ...
    void Update()
    {
        ...
        // Presión normalizada 0-1 según rotación
        ...
        if (isPlaying)
        {
            ...
            // Si la tecla sube demasiado, parar el sonido
    ...
    void OnTriggerEnter(Collider other)
    {
        ...
        if (touchCount == 1)
        {
            ...
            {
                // Ya sonando — actualizar velocidad si se aprieta más fuerte
    ...
    void OnTriggerExit(Collider other)
    {
        ...
        if (touchCount <= 0)
        {
            touchCount = 0;
            isPressed = false;
            // El sonido para solo cuando la presión cae por debajo de minPressure en Update
        }
    }
